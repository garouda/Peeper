...
function menu.reset()
  ...
  end, menu.box.w/2 - 125/2, screen_height, 125, 45)
  collectgarbage()
end
--
...
function menu.update(dt)
  ...
  buttons.sort.y = menu.box.y+menu.box.h/2-buttons.sort.h/2
  buttons.sort.x = menu.box.w/2 - 125/2
...
function menu.draw()
  ...
  buttons.sort:draw()
  if menu.show_buttons then for i,v in ipairs(buttons) do v:draw() end end
end
--
...
function menu.mousepressed(x,y,b,t)
  if buttons.sort:mousepressed(x,y,b,t) then return end
  for i,v in ipairs(buttons) do if v:mousepressed(x,y,b,t) then return end end
...
function menu.mousereleased(x,y,b,t)
  if buttons.sort:mousereleased(x,y,b,t) then return end
  if not menu.show_buttons then return end
  for i,v in ipairs(buttons) do if v:mousereleased(x,y,b,t) then return end end
end
--
